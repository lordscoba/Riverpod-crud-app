...
abstract class $UserModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String username, String password, String email});
}
...
// required int id,
  ...
  @override
  String toString() {
    return 'UserModel(name: $name, username: $username, password: $password, email: $email)';
  }
...
class _$_UserState extends _UserState {
  ...
  @override
  String toString() {
    return 'UserState(data: $data, isLoading: $isLoading, error: $error)';
  }
